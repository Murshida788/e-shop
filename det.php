...
<div style="width: 18rem">
  <img src="img/jacket.jpeg" class="card-img-top" alt="item">

 <p class="card-text"><strong>The frabic quality is high</strong></p>
  <p class="card-text"><strong>Fashionable</strong></p>
  <p class="card-text"><strong>Easy to carry</strong></p>
 <p class="card-text"><strong>BDT.400.00</strong></p>
